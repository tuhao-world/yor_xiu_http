...
class CustomHttpException implements Exception {
  ...
  factory CustomHttpException.create(DioError error) {
    switch (error.type) {
              ...
              default:
                {
                  ...
                  return CustomHttpException(errCode, error.response?.statusMessage);
                }
            }
          } on Exception catch (_) {
            return CustomHttpException(-1, "未知错误");
          }
        }
      default:
        {
          return CustomHttpException(-1, error.message);
        }
    }
  }
}
